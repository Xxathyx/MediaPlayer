...
public class v1_20_R4 implements ActionBar {
    ...
    public void send(Player player, String text) {		
		try {
			((PlayerConnection) ((org.bukkit.craftbukkit.v1_20_R4.entity.CraftPlayer)player).getHandle().getClass().getFields()[0].get(
					((org.bukkit.craftbukkit.v1_20_R4.entity.CraftPlayer)player).getHandle())).a(new net.minecraft.network.protocol.game.ClientboundSetActionBarTextPacket(
