...
/**
 * The v1_18_R2 class implements {@link ActionBar}, it can only be defined once if
...
public class v1_18_R2 implements ActionBar {
	
	@Override
    public void send(Player player, String text) {
		((org.bukkit.craftbukkit.v1_18_R2.entity.CraftPlayer)player).getHandle().b.a(new net.minecraft.network.protocol.game.PacketPlayOutChat(
