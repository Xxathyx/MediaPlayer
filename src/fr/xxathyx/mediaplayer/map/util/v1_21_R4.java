...
/**
 * The v1_21_R4 class implements {@link MapUtil}, it can only be defined once if
...
public class v1_21_R4 implements MapUtil {
		...
		try {
			...
			if(isPaper) {
				...
				net.minecraft.server.network.PlayerConnection connection = ((net.minecraft.server.network.PlayerConnection) entityPlayer.getClass().getFields()[5].get(
						((org.bukkit.craftbukkit.v1_21_R4.entity.CraftPlayer)player).getHandle()));
