...
/**
 * The v1_19_R1 class implements {@link MapUtil}, it can only be defined once if
...
public class v1_19_R1 implements MapUtil {

	@Override
	public void update(Player player, int id, byte[] buffer) {	    	
    	((org.bukkit.craftbukkit.v1_19_R1.entity.CraftPlayer)player).getHandle().b.a(new net.minecraft.network.protocol.game.PacketPlayOutMap(id, (byte) 4, false,
