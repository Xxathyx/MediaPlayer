...
/**
 * The v1_15_R1 class implements {@link MapUtil}, it can only be defined once if
...
public class v1_15_R1 implements MapUtil {

	@Override
	public void update(Player player, int id, byte[] buffer) {
		((org.bukkit.craftbukkit.v1_15_R1.entity.CraftPlayer)player).getHandle().playerConnection.sendPacket(new net.minecraft.server.v1_15_R1.PacketPlayOutMap(id, (byte) 4, false,
