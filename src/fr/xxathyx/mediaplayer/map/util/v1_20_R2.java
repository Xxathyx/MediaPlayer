...
/**
 * The v1_20_R2 class implements {@link MapUtil}, it can only be defined once if
...
public class v1_20_R2 implements MapUtil {
	...
	public void update(Player player, int id, byte[] buffer) {
		try {
			((PlayerConnection) ((org.bukkit.craftbukkit.v1_20_R2.entity.CraftPlayer)player).getHandle().getClass().getFields()[0].get(
					((org.bukkit.craftbukkit.v1_20_R2.entity.CraftPlayer)player).getHandle())).a(
